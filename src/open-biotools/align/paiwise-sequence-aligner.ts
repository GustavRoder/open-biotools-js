...
/// </summary>
export interface IPairwiseSequenceAligner implements ISequenceAligner {
  /// <summary>
  ...
  alignSimple(sequence1: ISequence, sequence2: ISequence): IPairwiseSequenceAlignment[];
  ...
  /// <param name="sequence2">Second input sequence.</param>
  /// <returns>List of Aligned Sequences.</returns>
  align(sequence1: ISequence, sequence2: ISequence): IPairwiseSequenceAlignment[];
}
